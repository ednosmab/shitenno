...
| Document | Purpose |
|----------|---------|
| [Engineering Manifesto](../../docs/handbook/philosophy/engineering-manifesto.md) | Why Shugo exists — the problem, the role of AI, the role of the engineer |
| [Principles](../../docs/handbook/philosophy/principles.md) | Six immutable principles that govern all decisions |
| [Vision](../../docs/handbook/philosophy/vision.md) | Long-term direction — three phases of evolution |
...
| [Problem Statement](../../docs/domain/problem-statement.md) | The problem Shugo exists to solve |
| [Knowledge](../../docs/domain/knowledge.md) | What knowledge means in the Shugo context |
