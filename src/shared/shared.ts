...
import { detectLifecycleState, canRunCommand, type ShitennoLifecycleState } from "../infrastructure/shitenno-state-machine.js";
import { COMMAND_GATES } from "../domain/types/constants.js";
...
export async function withCache<T>(
  ...
  const { getCached, setCache, computeKeyChecksums } = await import("../infrastructure/cache.js");
