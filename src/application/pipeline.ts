...
import { getHookBus } from "../infrastructure/plugin-system.js";
...
export interface PipelineContext {
  ...
  analysis?: import("../infrastructure/analyser.js").ProjectAnalysis;
  complexityReport?: import("./scorer.js").ComplexityReport;
  patternReport?: import("../infrastructure/pattern-detector.js").PatternDetectionReport;
...
export async function createDefaultPipeline(): Promise<Pipeline> {
  ...
  const { detectPatterns } = await import("../infrastructure/pattern-detector.js");
