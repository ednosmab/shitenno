...
export type {
  EventVersion,
  VersionedEvent,
} from "./infrastructure/versioning.js";
...
export type { DeadLetterEvent } from "./infrastructure/dead-letter.js";
export { DeadLetterQueue } from "./infrastructure/dead-letter.js";

export type { ReplayResult } from "./infrastructure/event-replayer.js";
export { EventReplayer } from "./infrastructure/event-replayer.js";

// ── Re-export factory ──────────────────────────────────────────────────────

import { randomUUID } from "node:crypto";
import type { ShitennoEventType } from "./event-bus.js";
import type { VersionedEvent, EventVersion } from "./infrastructure/versioning.js";
import { EVENT_VERSIONS } from "./infrastructure/versioning.js";
